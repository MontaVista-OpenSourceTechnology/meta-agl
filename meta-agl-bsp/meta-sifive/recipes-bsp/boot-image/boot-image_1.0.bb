...
do_install() {
	...
	# this would be for upstream layer
	#install -m 0644 "${THISDIR}/../../scripts/lib/wic/canned-wks/${MACHINE}-emmc-extlinux.conf" "${DEPLOY_DIR_IMAGE}/extlinux/extlinux.conf"
	# this is the temporary solution for meta-agl-bsp
	install -m 0644 "${THISDIR}/../../../../../bsp/meta-sifive/scripts/lib/wic/canned-wks/${MACHINE}-emmc-extlinux.conf" "${DEPLOY_DIR_IMAGE}/extlinux/extlinux.conf"
